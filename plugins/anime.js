...
if (Config.WORKTYPE == 'private') {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*⎝🛡️ QUEEN ALEXA  🛡️⎠*'})
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*⎝🛡️ QUEEN ALEXA  🛡️⎠*' ,quoted: message.data})
