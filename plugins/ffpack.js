...
if (Config.WORKTYPE == 'public') {
 ...
 Trex.addrex({ pattern: 'ff9 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption:  ' ⎝🛡️ ALEXA 🛡️⎠   ' ,quoted: message.data })
 ...
 Trex.addrex({ pattern: 'ff12 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Trex.addrex({ pattern: 'ff14 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption:  ' ⎝🛡️ALEXA  🛡️⎠   '  ,quoted: message.data})
 ...
 Trex.addrex({ pattern: 'ff9 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption:  ' ⎝🛡️ ALEXA 🛡️⎠   ' })
